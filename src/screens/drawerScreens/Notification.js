  ...
  return (
    <View
      style={{
        height: '100%',
        width: '100%',
        backgroundColor: notification.length > 0 ? 'white' : '#ECF4FD',
      }}>
  ...
  return (
    <View
      style={{
        ...
        paddingLeft: 20,
        paddingVertical: 15,
        backgroundColor: color_combination[1].primary,
      }}>
      <View style={{flexDirection: 'row', alignItems: 'center'}}>
        <Image
          source={require('../../assets/noNotificationn.png')}
          style={{height: 20, width: 20, tintColor: color_combination[1].secoundary}}
        />
        <Text
          style={{
            fontWeight: 'bold',
      ...
      <View style={{marginTop: 10}}>
        <Text
          ...
          Your task is starting in just a few minutes.... ⌛
        </Text>
        <Text
          style={{
            fontWeight: 'bold',
            fontSize: 16,
            paddingLeft: 20,
            color: color_combination[1].secoundary,
          }}>
          Task : Car Washing
        </Text>
        <Text
        ...
        <Text
          ...
          get ready to tackle your task with focus and energy!
        </Text>
...
const NoNotification = () => {
  return (
    <View style={{alignItems: 'center', alignSelf: 'center'}}>
      <Image
        source={require('../../assets/noNotificationn.png')}
        style={{height: 150, width: 150, tintColor: '#bababa'}}
      />
      <Text
        style={{
          fontSize: 25,
